    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4 pt-2">
        <div>
          ...
          <div className="text-[#00ff00] text-2xl font-mono">${dailyRewardsPool.toLocaleString()}</div>
        </div>

        <div>
          <div className="text-gray-400">Your Daily Earnings:</div>
          <div className="text-[#00ff00] text-2xl font-mono">${dailyEarnings.toLocaleString()}</div>
        </div>

        <div>
          <div className="text-gray-400">Token Burn Amount:</div>
          <div className="text-[#00ff00] text-2xl font-mono">${tokenBurn.toLocaleString()}</div>
        </div>
      </div>
    </div>
  )
